...
class Cell:
    def __init__(self, row, col, cell_size, value, is_correct_guess = None):
        ...
        self.guesses = None if self.value != 0 else [0 for _ in range(9)]
        self.color = pygame.Color(0, 128, 170)           #lighter_navi_color = pygame.Color(0, 128, 170)
    ...
    def update(self, screen, SRN = None):
        ...
        if self.value != 0:
            font_color = pygame.Color("green") if self.is_correct_guess else pygame.Color("red")
